    ...
    <main className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 sm:px-6 lg:px-8">
      <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div className="grid gap-8 p-8 md:grid-cols-[220px_1fr] md:items-center">
          <img src={profile.photo} alt={profile.name} className="h-56 w-full rounded-2xl object-cover" />
          <div className="space-y-4">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-emerald-600">Planter profile</p>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl bg-slate-50 p-4">
                ...
                <p className="text-2xl font-semibold text-slate-900">{profile.reputationScore}/100</p>
              </div>
              <div className="rounded-2xl bg-slate-50 p-4">
              ...
              <div className="rounded-2xl bg-slate-50 p-4">
                ...
                <p className="text-2xl font-semibold text-slate-900">{profile.completedJobs.length}</p>
              </div>
            </div>
      ...
      <section>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {profile.completedJobs.map((job) => (
            <article key={job.id} className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
